                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($v_published_product->product_image)}}" alt="" style="height: 200px;" />
                                            <h2>{{$v_published_product->product_prize}} tk.</h2>
                                            <p>{{$v_published_product->product_short_description}}</p>
